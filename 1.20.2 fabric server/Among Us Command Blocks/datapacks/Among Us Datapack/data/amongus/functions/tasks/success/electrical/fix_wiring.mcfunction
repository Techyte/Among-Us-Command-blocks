...
execute as @s[scores={wiring_tasks_left=1..}] if score Manager randomNumber matches 1 run tag @s add navigation_fix_wiring
execute as @s[scores={wiring_tasks_left=1..}] if score Manager randomNumber matches 1 run tellraw @s {"text":"The next part of this task takes place in: Navigation, Fix Wiring","color": "green"}

execute as @s[scores={wiring_tasks_left=1..}] if score Manager randomNumber matches 2 run tag @s add security_fix_wiring
execute as @s[scores={wiring_tasks_left=1..}] if score Manager randomNumber matches 2 run tellraw @s {"text":"The next part of this task takes place in: Security, Fix Wiring","color": "green"}
