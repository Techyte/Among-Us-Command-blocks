...
execute if score @s samplesCooldown > math samplesCooldown run title @s actionbar [{"text":"Please Wait ","color":"yellow"},{"score":{"name":"@s","objective":"samplesCooldown"},"color":"green"},{"text":" second(s)","color":"green"}]