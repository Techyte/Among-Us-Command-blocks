...
execute as @a[tag=voteConfirmed,team=Alive] run scoreboard players add Manager votedPlayers 1
execute as @a[team=Alive] run scoreboard players add Manager totalPlayersToVote 1
