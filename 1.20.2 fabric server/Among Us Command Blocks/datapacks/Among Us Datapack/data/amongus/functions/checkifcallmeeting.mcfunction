...
execute if score @s InteractionAllowed matches 0 run title @s actionbar {"text": "Meeting cannot be called during a sabotage","color": "red"}
...
execute if score @s meetings matches 0 run title @s actionbar {"text": "You have no more meetings left","color": "red"}
...
execute if entity @a[tag=inmeeting] run title @s actionbar {"text": "You cannot call a meeting during a meeting","color": "red"}
...
execute unless score Manager meetingCooldown matches 0 run title @s actionbar [{"text": "Please wait ","color": "red"},{"score":{"name":"Manager","objective":"meetingCooldown"},"color":"yellow"},{"text": " second(s) before calling a meeting","color": "red"}]
