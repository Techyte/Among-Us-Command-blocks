...
execute as @a[team=Alive,tag=blue] at @s run tellraw @a[team=Alive] [{"selector":"@s","color": "blue"},{"text":" (blue):"},{"text":"votes: "},{"score":{"name":"@s","objective":"votes"},"color":"blue"}]
...
execute as @a[team=Alive,tag=cyan] at @s run tellraw @a[team=Alive] [{"selector":"@s","color": "aqua"},{"text":" (cyan):"},{"text":"votes: "},{"score":{"name":"@s","objective":"votes"},"color":"aqua"}]
...
execute as @a[team=Alive,tag=coral] at @s run tellraw @a[team=Alive] [{"selector":"@s","color": "light_purple"},{"text":" (coral):"},{"text":"votes: "},{"score":{"name":"@s","objective":"votes"},"color":"light_purple"}]
